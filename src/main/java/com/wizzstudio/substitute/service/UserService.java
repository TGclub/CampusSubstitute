...
public interface UserService {
     ...
     */
    User modifyUserInfo(Integer id, ModifyUserInfoDTO newInfo);
     ...
     */
    boolean addReferrer(Integer userId, Integer masterId);
     ...
     * @return 用户的基本信息
     */
    ApprenticeBasicInfo getApprenticeInfo(Integer userId);
}
